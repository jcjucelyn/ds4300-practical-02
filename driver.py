    ...
    while True:
        ...
        if benchmark_choice:
            ...
            if not compare_models and not compare_prompts and not compare_vdbs and not compare_embeddings:
                ...
                model_name = check_validity(model_name, model_options)
        ...
        # else:
        if query_eval:
            print("\n---\nThe following questions are for generating the answer to your query:\n---")
            ...
            if collection_choice == "redis" or collection_choice == "mongo":
                ...
                try:
                    ...
                    print(f"Error: {e}. Creating chromaCollection...")
                ...
                context_results = search_embeddings(query, emb_type=embedding_choice, collection=collection_choice, chroma_coll=chroma_collection)
            else:
